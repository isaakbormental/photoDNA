        ...
        return (
            <div className="page page_readme">
                ...
                <div className="page_readme__inner">
                    <h1  className="page_readme__heading">Read more</h1>
                    <h2 className="page_readme__subheading">Machine learning will help to&nbsp;find more about yourself.</h2>
                    <p className="page_readme__text">Our technology will compare your features with a&nbsp;database of&nbsp;43&nbsp; nationalities. <br/>Then it&rsquo;ll identify similarities and show which 3&nbsp;nationality you remind the most.</p>
                    ...
                    <Button
                        className="button button_bottom page_readme__button"
